...
(function ($) {
    ...
    $.fn.BootSideMenu = function (userOptions) {
        ...
        body.originalMarginLeft = $("#manage-info").css("margin-left");
        body.originalMarginRight = $("#manage-info").css("margin-right");
        body.width = $("#manage-info").width();
        ...
        $("#test").css("margin-top", $("#manage-title").height() + 1);
        ...
        function startDefault() {
            if (options.side == "left") {
                if (options.autoClose) {
                    ...
                    menu.status = "opened";
                    if (options.pushBody) {
                        $("#manage-info").css("margin-left", menu.width() + 20);
                    }
                }
            } else if (options.side == "right") {
                if (options.autoClose) {
                    ...
                    menu.status = "opened";
                    if (options.pushBody) {
                        $("#manage-info").css("margin-right", menu.width() + 20);
                    }
                }
            }
        }
        ...
        function closeMenu(execFunctions) {
            ...
            if (options.side == "left") {
                ...
                if (options.pushBody) {
                    $("#manage-info").animate({marginLeft: body.originalMarginLeft}, {duration: options.duration});
                }
                ...
                if (options.pushBody) {
                    $("#manage-info").animate({marginRight: body.originalMarginRight}, {duration: options.duration});
                }
        ...
        function openMenu(execFunctions) {
            ...
            if (options.side == "left") {
                ...
                if (options.pushBody) {
                    $("#manage-info").animate({marginLeft: menu.width() + 20}, {duration: options.duration});
                }
                ...
                if (options.pushBody) {
                    $("#manage-info").animate({marginRight: menu.width() + 20}, {duration: options.duration});
                }
        ...
        function forSmallBody() {
            var bodyWidth = $("#manage-info").width();
            if (bodyWidth <= 480) {
